<div>
    ...
    <section class="flex flex-col  md:flex-row  items-center">
        ...
        <div class="bg-indigo-600  lg:block w-full md:w-1/3 xl:w-2/3 h-screen" style="background-image: cover">
            <img src="https://img.freepik.com/free-vector/elegant-paper-flowers-boutique-grey-pink-3d-illustration_317396-152.jpg?w=1060" alt="" class="w-full h-full object-cover">
        </div>
