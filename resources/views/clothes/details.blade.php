     ...
     <div class="py-6">
       ...
       <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
         <div class="flex flex-col md:flex-row -mx-4">
             ...
             <div >
               <div class=" mb-40 rounded-lg bg-gray-100 mb-4">
                 <div class=" rounded-lg bg-gray-100 mb-4 flex items-center justify-center">
                     <img src="/Uploads/Clothes/{{ $clothes->image }}"
           ...
           <div class="md:flex-1 px-4">
             <h2 class="mb-2 leading-tight tracking-tight font-bold text-gray-800 text-2xl md:text-3xl">{{ $clothes->excerpt }}.</h2>
             <p class="text-gray-500 text-sm capitalize"><a href="#" class="text-indigo-600 hover:underline">Brand  </a> {{ $clothes->brand }}</p>
 
             <p class="text-gray-500 text-sm uppercase"><a href="#" class="text-indigo-600 hover:underline">Location  </a> {{ $clothes->location }} <span>DELIVERY TIME: ERBIL 24 HOURS</span> </p>
 
     
             <div class="flex items-center space-x-4 my-4">
             
               <div class="flex-1">
                 <p class="text-green-500 text-xl font-semibold">Save {{ number_format($clothes->price,0,'.','.') }} USD</p>
                 <p class="text-gray-400 text-sm">Inclusive of all Taxes.</p>
               </div>
             </div>
     
             <p class="text-gray-500">
                 web page on an eCommerce site that presents the description of a specific product in view. The details displayed often include size, color, price, shipping information, reviews, and other relevant.</p>
