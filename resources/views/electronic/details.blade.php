<div>
    ...
    @section('title','Details Electronic')
        ...
        <div class="mt-10 mb-10">
            ...
            <div class="  px-4 sm:px-6 lg:px-8">
                <div class="flex items-center space-x-2 text-gray-400 text-sm">
                    ...
                    <a href="{{ route('Electronic') }}" class="hover:underline hover:text-blue-600">Electronics</a>
                    <span>
                        <svg class="h-5 w-5 leading-none text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                ...
                <div class="flex flex-col md:flex-row -mx-4">
                        ...
                        <div>
                            <div class=" mb-40 rounded-lg bg-gray-100 mb-4">
                                <div class=" rounded-lg bg-gray-100 mb-4 flex items-center justify-center">
                                    <img src="/Uploads/Electronics/{{ $electronic->image }}" role="img"
                    ...
                    <div class="md:flex-1 px-4">
                        <h2 class="mb-2 leading-tight tracking-tight font-bold text-gray-800 text-2xl md:text-3xl">
                            {{ $electronic->excerpt }}.</h2>
                        <p class="text-gray-500 text-sm capitalize"><a href="#"
                                class="text-indigo-600 hover:underline">Brand </a> {{ $electronic->brand }}</p>

                        <p class="text-gray-500 text-sm uppercase"><a href="#"
                                class="text-indigo-600 hover:underline">Location </a> {{ $electronic->location }}
                        ...
                        <div class="flex items-center space-x-4 my-4">
                            ...
                            <div class="flex-1">
                                <p class="text-green-500 text-xl font-semibold">Save
                                    {{ number_format($electronic->price,0,'.','.') }} USD</p>
